...
# Use the Gemini API key from your .env file
GEMINI_API_KEY = "AIzaSyDkvrRKaXNQmWYFruVB_m9zH7AiePodPKs"
...
try:
    ...
    print("Gemini initialized successfully with gemini-2.5-flash model")
except Exception as e:
    print(f"Error initializing Gemini: {e}")
    print("Please update the GEMINI_API_KEY in this file")
    gemini_model = None
...
async def chat(request: ChatRequest):
    ...
    try:
        ...
        if not gemini_model:
            raise HTTPException(status_code=500, detail="Gemini model not initialized. Please update GEMINI_API_KEY")
