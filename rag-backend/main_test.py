...
# Hardcoded API key for testing (you should replace this with your actual key)
GEMINI_API_KEY = "AIzaSyAajRFarICHMGt8wzfCn-xLlHAPYeYSG1E"

print("Initializing with hardcoded API key...")
