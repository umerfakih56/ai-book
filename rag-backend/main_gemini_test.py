...
# Get Gemini API key from environment (without dotenv to avoid parsing issues)
...
async def chat(request: ChatRequest):
    ...
    try:
        ...
        if not gemini_model:
            raise HTTPException(status_code=500, detail="Gemini model not initialized. Please check GEMINI_API_KEY in .env file")
